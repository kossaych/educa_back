# Generated by Django 4.2.4 on 2024-01-05 16:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2024, 1, 5, 16, 31, 44, 855911, tzinfo=datetime.timezone.utc), editable=False)),
            ],
        ),
        migrations.CreateModel(
            name='Video',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='content.summary')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.datetime(2024, 1, 5, 16, 31, 44, 871542, tzinfo=datetime.timezone.utc), error_messages={'invalid': 'Invalid date format. Please provide a valid date.'})),
