# Generated by Django 4.2.4 on 2023-12-31 11:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(db_comment='Chapiter title', db_index=True, error_messages={'blank': 'The title cannot be left blank.', 'null': 'The title cannot be null.'}, max_length=200, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='content.chapiter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime(2023, 12, 31, 11, 54, 25, 863946, tzinfo=datetime.timezone.utc), editable=False)),
            ],
        ),
        migrations.CreateModel(
            name='VideoComment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.datetime(2023, 12, 31, 11, 54, 25, 863946, tzinfo=datetime.timezone.utc), error_messages={'invalid': 'Invalid date format. Please provide a valid date.'})),
        ...
        migrations.AddField(
            model_name='chapiter',
            name='subject',
            field=models.ForeignKey(db_comment='Chapiter subject', error_messages={'blank': 'Please select a subject.'}, on_delete=django.db.models.deletion.PROTECT, to='content.subject'),
        ),
    ]
